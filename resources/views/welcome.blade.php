...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
            canvas{
                background-image: url("http://al-rashid.test/storage/image.jpeg");
                background-position: center;
                background-size: contain;
                background-repeat: no-repeat;

            }
            .canC { width:500px;  height:500px; border:1px black solid;}
         </style>
...
{{--            console.log("end start x :"+stopX +", start y :"+stopY);--}}
{{--        }--}}
{{--    });--}}
